...
export class CIVerifier {
    async verifyCommit(commitSha = 'd8018a2c3b4a5e6f7a8b9c0d1e2f3a4b5c6d7e8f', sourceMode = 'fixture', localOrRepoPath) {
        let repoSource;
        ...
        const mutationMethods = methodNames.filter(method => mutationKeywords.some(keyword => method.toLowerCase().includes(keyword)));
...
//# sourceMappingURL=CIVerifier.js.map